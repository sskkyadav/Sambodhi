...
<form action="" method="post" id="invitations-bulk-management">
	<table class="invitations">
		<thead>
			<tr>
				<th class="bulk-select-all"><label class="youzify-cs-checkbox-field" for="select-all-invitations"><input id="select-all-invitations" type="checkbox"><div class="youzify_field_indication"></div></label></th>
			...
			<?php while ( bp_the_members_invitations() ) : bp_the_members_invitation(); ?>
				...
				<tr>
					<td class="bulk-select-check">
						<label class="youzify-cs-checkbox-field" for="<?php bp_the_members_invitation_property( 'id', 'attribute' ); ?>">
					...
					<td class="invitation-actions"><?php bp_the_members_invitation_action_links( array( 'sep' => '' ) ); ?></td>
				</tr>
