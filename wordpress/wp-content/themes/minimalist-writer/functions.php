<?php 
// Get parent CSS
add_action( 'wp_enqueue_scripts', 'minimalist_writer_enqueue_styles' );
function minimalist_writer_enqueue_styles() {
	wp_enqueue_style( 'minimalist-writer-parent-style', get_template_directory_uri() . '/style.css' ); 
} 
...
// Get new fonts
function minimalist_writer_enqueue_assets() {
    // Include the file.
    ...
    wp_enqueue_style(
        'Great Vibes',
        wptt_get_webfont_url( 'https://fonts.googleapis.com/css?family=Great+Vibes:400' ),
        array(),
        ''
    );
}
add_action( 'wp_enqueue_scripts', 'minimalist_writer_enqueue_assets' );


// New customizer options
function minimalist_writer_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
	$wp_customize->get_section('header_image')->title = __( 'Header Settings', 'minimalist-writer' );
	$wp_customize->remove_section("colors");

	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			'selector'        => '.site-title a',
			'render_callback' => 'minimalist_writer_customize_partial_blogname',
		) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'minimalist_writer_customize_partial_blogdescription',
		) );
	}
	...
	$wp_customize->add_section( 'image_banner', array(
		'title'      => __('Image Banner','minimalist-writer'),
		'priority'   => 1,
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'imagebanner_text_color', array(
		'label'       => __( 'Text Color', 'minimalist-writer' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'imagebanner_background_color', array(
		'label'       => __( 'Background Color', 'minimalist-writer' ),
		'section'     => 'image_banner',
		'priority'   => 1,
	...
	$wp_customize->add_control( 'banner_img_firsttext', array(
		'label'    => __( "Text Before Title", 'minimalist-writer' ),
		'section'  => 'image_banner',
		'type'     => 'text',
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( 'banner_img_secondtext', array(
		'label'    => __( "Title", 'minimalist-writer' ),
		'section'  => 'image_banner',
		'type'     => 'text',
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( 'banner_img_thidtext', array(
		'label'    => __( "Text After Title", 'minimalist-writer' ),
		'section'  => 'image_banner',
		'type'     => 'text',
		'priority' => 1,
	) );
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'image_banner_bgimage', array(
		'label'             => __('Background Image', 'minimalist-writer'),
		'section'           => 'image_banner',
	...
	$wp_customize->add_control( 'img_banner_link', array(
		'label'    => __( "Text link", 'minimalist-writer' ),
		'section'  => 'image_banner',
		'type'     => 'text',
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_logo_color', array(
		'label'       => __( 'Header Logo Color', 'minimalist-writer' ),
	...
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'header_background_color', array(
		'label'       => __( 'Header Background Color', 'minimalist-writer' ),
		'section'     => 'header_image',
		'priority'   => 1,
...
add_action( 'customize_register', 'minimalist_writer_customize_register', 999 );


if(! function_exists('minimalist_writer_customizer_css_final_output' ) ):
	function minimalist_writer_customizer_css_final_output(){
		?>
	...
	<?php }
	add_action( 'wp_head', 'minimalist_writer_customizer_css_final_output' );
endif;
