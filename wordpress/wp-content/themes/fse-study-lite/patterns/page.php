<?php
 /**
  * Title: Page Layout
  * Slug: fse-study-lite/page
  * Categories: fse-study-lite, page
  */
?>
<!-- wp:group -->
<div class="wp-block-group"><!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri( ).'/images/slider1.jpg'); ?>","id":1961,"dimRatio":50,"minHeight":200,"isDark":false} -->
    ...
    <!-- wp:group {"style":{"spacing":{"padding":{"top":"30px","right":"0px","bottom":"30px","left":"0px"}}}} -->
<div class="wp-block-group" style="padding-top:30px;padding-right:0px;padding-bottom:30px;padding-left:0px"><!-- wp:group {"layout":{"inherit":true}} -->
