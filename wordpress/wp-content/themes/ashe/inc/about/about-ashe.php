...
?>
	...
	<div class="wrap">
		...
		<div class="welcome-text">
			<p>
				<span><?php /* translators: %s theme name */ printf( esc_html__( '%s theme is one of the most Popular Free WordPress theme of 2021-2022 years. To understand better what the theme can offer, please click the button below.', 'ashe' ), esc_html( $theme_data->Name ) ); ?></span>
				<br>
			...
			<div class="four-columns-wrap getting-started">
				...
				<div class="column-width-4 ashe-woocommerce-inst-box">
					...
					<p>
						...
						echo wp_kses( 'With Ashe theme you can build a beautiful <a style="color: #3858E9;" href="https://wp-royal.com/themes/ashe-free/demo/shop/?ref=ashe-free-backend-about-shop-prev-btn" target="_blank">online shop</a> with ease, just install the Woocommerce plugin and start building your shop today!', $allowed_html); ?>
					</p>
					...
					<?php endif; ?>
					<a style="width: 215px; display: block" href="<?php echo esc_url('https://wp-royal.com/video-tutorial-coming-soon/') ?>" target="_blank" class="button button-primary import-video"><span class="dashicons dashicons-video-alt3"></span><?php esc_html_e( 'Shop Setup Video Tutorial', 'ashe' ); ?></a>
				</div>
