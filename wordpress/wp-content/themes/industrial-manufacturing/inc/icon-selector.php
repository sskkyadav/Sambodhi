...
class Industrial_Manufacturing_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'industrial-manufacturing'); ?>">
                      </div>
                    <?php
                    $industrial_manufacturing_font_awesome_icon_array = industrial_manufacturing_font_awesome_icon_array();
                    foreach ($industrial_manufacturing_font_awesome_icon_array as $industrial_manufacturing_font_awesome_icon) {
                            $icon_class = $this->value() == $industrial_manufacturing_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($industrial_manufacturing_font_awesome_icon).'"></i>
                            <span class="industrial-manufacturing-social-class">'.esc_attr($industrial_manufacturing_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function industrial_manufacturing_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'industrial_manufacturing_customizer_script' );

if(!function_exists('industrial_manufacturing_font_awesome_icon_array')){
    function industrial_manufacturing_font_awesome_icon_array(){
