...
function education_academy_coach_meta_callback_courses( $post ) {
  ...
  $courses_amount = get_post_meta( $post->ID, 'education_academy_coach_courses_amount', true );
  $courses_lesson = get_post_meta( $post->ID, 'education_academy_coach_courses_lesson', true );
  $courses_student = get_post_meta( $post->ID, 'education_academy_coach_courses_student', true );
  ?>
  <table id="list">
    <tbody id="the-list" data-wp-lists="list:meta">
      <tr id="meta-8">
        ...
        <td class="left">
          <input type="text" name="education_academy_coach_courses_amount" id="education_academy_coach_courses_amount" value="<?php echo esc_attr($courses_amount); ?>" />
        </td>
      </tr>
      <tr id="meta-8">
        <td class="left">
        ...
        <td class="left">
          <input type="text" name="education_academy_coach_courses_lesson" id="education_academy_coach_courses_lesson" value="<?php echo esc_attr($courses_lesson); ?>" />
        </td>
      </tr>
      <tr id="meta-8">
        <td class="left">
        ...
        <td class="left">
          <input type="text" name="education_academy_coach_courses_student" id="education_academy_coach_courses_student" value="<?php echo esc_attr($courses_student); ?>" />
        </td>
      </tr>
    </tbody>
  </table>
