...
class Bloghill_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'bloghill';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'bloghill' ), $i ),
...
// Initialize.
$bloghill_footer_widgets = new Bloghill_Footer_Widgets();
