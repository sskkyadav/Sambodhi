 ...
 */
class Bloghill_Dropdown_Taxonomies_Control extends WP_Customize_Control {
...
class Bloghill_Note_Control extends WP_Customize_Control {
...
class Bloghill_Switch_Control extends WP_Customize_Control{
	public $type = 'switch';
...
class  bloghill_Dropdown_Multiple_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="bloghill-chosen-select" multiple <?php $this->link(); ?>>
                    <?php
...
class Bloghill_Dropdown_Chooser extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="bloghill-chosen-select" <?php $this->link(); ?>>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
 ...
 */
class Bloghill_Custom_Radio_Image_Control extends WP_Customize_Control {
...
class  bloghill_Customize_Sortable_Control extends WP_Customize_Control {
  ...
  public function render_content() {
    ...
    <ul class="bloghill-sortable-list">
 
      <?php
       foreach ( $values_choices as $value ){  ?>

      	<?php if ($options[$value.'_section_enable'] !== false ): ?>
	        <li>
	            <input class="bloghill-sortable-input sortable-hideme" name="<?php echo esc_attr( $value ); ?> " type="hidden"  value="<?php echo esc_attr( $value ); ?>" />
	            <span class ="menu-item-handle sortable-span"> <?php echo esc_attr( $choices[$value] ); ?> </span>
	          <i class="dashicons dashicons-menu bloghill-drag-handle"></i>
	        </li>
    	<?php endif; ?>
        ...
        <li class="sortable-hideme">
          <input class="bloghill-sortable-value" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
        </li>
...
class Bloghill_Customize_Column extends WP_Customize_Control {
	public $type = 'hr';
...
class Bloghill_Icon_Picker extends WP_Customize_Control{
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <input id="bloghill-<?php echo esc_attr( $id ); ?>" placeholder="<?php esc_attr_e( 'Click here to select icon', 'bloghill' ); ?>" class="bloghill-icon-picker input" <?php $this->link(); ?> value="<?php echo esc_attr( $this->value() ); ?>" />
            </label>
		<?php
	}
}
...
class Bloghill_Customize_Horizontal_Line extends WP_Customize_Control {
	public $type = 'hr';
 ...
 * @see WP_Customize_Control
 */
class Bloghill_Dropdown_Category_Control extends WP_Customize_Control {
 ...
 * @since  1.0.0
 */
class Bloghill_Multi_Input_Custom_Control extends WP_Customize_Control {
	/**
	 * Control type
	 *
	 * @var string
...
class Bloghill_Multiple_Dropdown_Chooser extends WP_Customize_Control{
	public $type = 'dropdown_chooser';
	...
	public function render_content(){
		...
		?>
            <label>
                ...
                <select class="bloghill-chosen-select" <?php $this->link(); ?> multiple>
                    <?php
                    foreach ( $this->choices as $value => $label )
                        echo '<option value="' . esc_attr( $value ) . '"' . selected( $this->value(), $value, false ) . '>' . esc_html( $label ) . '</option>';
                    ?>
