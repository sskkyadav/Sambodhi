...
if ( ! class_exists( 'Elemento_IT_Solutions_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Elemento_IT_Solutions_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Elemento_IT_Solutions_WPTT_WebFont_Loader( $url );
