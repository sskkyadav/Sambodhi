...
function elemento_it_solutions_activation_notice() {
	...
	echo '<p>'. esc_html__( 'To import homepage data install recommended plugins.', 'elemento-it-solutions' ) .'</p>';
	echo '<p><a href="'. esc_url( admin_url( 'themes.php?page=elemento-it-solutions-about' ) ) .'" class="button button-primary">'. esc_html__( 'Documentation', 'elemento-it-solutions' ) .'</a></p>';
	echo '</div>';
}
...
require get_parent_theme_file_path( '/includes/about-theme/about-theme.php' );
                            ...
                            <div class="comment-meta">
                                <a href="<?php echo esc_url(get_comment_link($comment->comment_ID)); ?>">
                                    <time datetime="<?php comment_time('c'); ?>">
                                        <?php /* translators: %s: Date */ printf( esc_attr('%1$s at %2$s', '1: date, 2: time', 'elemento-it-solutions'), esc_attr( get_comment_date() ), esc_attr( get_comment_time() ) ); ?>
                                    </time>
                                </a>
...
add_action( 'wp_enqueue_scripts', 'elemento_it_solutions_load_dashicons_front_end' );
function elemento_it_solutions_load_dashicons_front_end() {
