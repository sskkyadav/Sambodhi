...
<?php if ( bp_has_blogs( bp_ajax_querystring( 'blogs' ) ) ) : ?>
	...
	<ul id="youzify-blogs-list" class="<?php echo youzify_sites_list_class(); ?>">

	<?php while ( bp_blogs() ) : bp_the_blog(); ?>

		<li <?php bp_blog_class() ?>>

			<div class="youzify-blog-data">

			<div class="item-avatar">
				<a href="<?php bp_blog_permalink(); ?>"><div class="youzify-blog-avatar"><?php bp_blog_avatar( 'type=full&width=100&height=100' ); ?></div></a>
			</div>
