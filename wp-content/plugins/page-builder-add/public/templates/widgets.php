  ...
  if (function_exists('ppb_lpb_check_free_version_active')) {
    if (!function_exists('ulpb_available_pro_widgets') ) { $isPremUser = false; }
      ...
      for ($j = 0; $j < count($colWidgets); $j++) {  // widgets loop
          ...
          if ($thisWidget['widgetType'] == 'wigt-btn-gen' || $thisWidget['widgetType'] == 'wigt-WYSIWYG' || $thisWidget['widgetType'] == 'wigt-pb-text' || $thisWidget['widgetType'] == 'wigt-pb-navmenu' || $thisWidget['widgetType'] == 'wigt-pb-pricing' || $thisWidget['widgetType'] == 'wigt-pb-cards' || $thisWidget['widgetType'] == 'wigt-pb-formBuilder' || $thisWidget['widgetType'] == 'wigt-pb-liveText' )  {
          ...
          switch ($this_column_type) {
            ...
            case 'wigt-img':
              ...
              if ( $this_widget_img_content['imgwccdis'] != 'hidden' ) {
                ...
                if(1 === preg_match('~[0-9]~', $this_widget_img_content['imgwctff'])){
                  $this_widget_img_content['imgwctff'] = "'".$this_widget_img_content['imgwctff']."'";
                }
              ...
              if (isset($this_widget_img_content['imgLinkOpen'])) {
                $imgTarget = $this_widget_img_content['imgLinkOpen'];
              }
            ...
            case 'wigt-btn-gen':
              ...
              $this_widget_btn = $renderredPopUp."
                <div class='wdt-$this_column_type parent-btn-$randomBtnClass' style='text-align:$btnAllignment;margin:0 0 2px 0; padding:0;' >
                  <a href='$btnLink' style='text-decoration:none !important;' target='$btnBlankAttr' id='btnLink-$randomBtnClass' ".$this_widget_btn_content['btnCAction']." >
            ...
            case 'wigt-pb-countdown':
              ...
              $countDownScript = "
                ...
                $(document).ready(function() {
                  if('$pbCountDownType' == 'evergreen'){
                    ...
                    var addedMinutesSeconds = todaysTime +  (((1*60000)*60)*24)*$pbCountDownDateDays  + (($pbCountDownDateHours*60000)*60) + ($pbCountDownDateMins+10)*60000 + $pbCountDownDateSecs*1000;
                    var expiryTimeForCookie = new Date(addedMinutesSeconds);
                    if(typeof($.cookie) !== 'undefined'){
                      
                      var countDownStoredTime = $.cookie('$countDownCookieId');
              ...
              $countDownContainer = "<div id=pb_countDown-".$countDownId." style='text-align:center;'></div>";
            ...
            case 'wigt-pb-pricing':
              ...
              $this_widget_btn = "
                <div class='wdt-$this_column_type parent-btn-$randomBtnClass' style='text-align:$btnAllignment; margin:0 0 2px 0; padding:0;' >
                  <a href='$btnLink' style='text-decoration:none !important;' target='$btnBlankAttr' id='btnLink-$randomBtnClass'>
              ...
              foreach ($imgCarouselSlidesURL as $imgCarouselThisSlideURL) {
                ...
                if (isset($imgCarouselSlidesLink[$slideCount])) {
                  if ($imgCarouselSlidesLink[$slideCount] != '') {
                    $slideLinkOpen = '<a href="'.$imgCarouselSlidesLink[$slideCount].'"  target="_blank" >';
                    $slideLinkClose = '</a>';
                  }
                }
            ...
            case 'wigt-pb-wooCommerceProducts':
              ...
              case 'wigt-pb-text':
                ...
                $textWidgetContentStyles = 'text-align:'.$widgetTextAlignment.'; color:'.$widgetTextColor.'; font-size:'.$widgetTextSize.'px; font-weight:'.$widgetTextWeight.'; text-transform:'.$widgetTextTransform.';  font-family:'.$widgetTextFamily.', sans-serif; font-weight:'.$widgetTextBold.';'
         ...
         /// $columnContentOld = 
          ...
          $widgetMarigns = "margin:".$widgetMtop."% ".$widgetMright."% ".$widgetMbottom."% ".$widgetMleft."%; $widgetPaddings  $this_widget_border_shadow  background: $widgetBgColor; $widgBackgroundOptions  $widgetIsInline text-align:$imgAlignment; $widgetWidthDefault";
