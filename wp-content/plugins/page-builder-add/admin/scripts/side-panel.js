...
$('#side-sortables').append('<br><span style="font-size:15px"> Don\'t like this plugin ? Please share the problem you are facing so we can fix it :   <a href="https://wordpress.org/support/plugin/page-builder-add/#new-topic-0" target="_blank"> Report an Issue </a></span>');
